...
export const MAX_LOG_ENTRIES_IMPORT_FILE_BYTES = MAX_LOG_ENTRIES_STORAGE_BYTES
export const MAX_LOG_ENTRIES_EXPORT_FILE_BYTES = MAX_LOG_ENTRIES_STORAGE_BYTES
